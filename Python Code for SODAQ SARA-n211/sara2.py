...
serial_name = os.getenv("serial_name", "com23")
info=[]

#acces token is your Device secret key found in the Wia dashboard
data = {"accessToken": os.getenv("accessToken", "d_sk_9IuyXyIlsN8ZZi1bdnYqRkfe"), "name": "28 August", "data": "12345"}
...
-r : Checking Network stastistics (AT+NUESTATS)" 
    try:
    ...
    for opt, arg in opts:
        if opt == '-h':
            ...
            garbeg1= status.replace("'\\r\\n'", ' ')
            garbeg2= garbeg1.replace("r\\n'", ' ')
            garbeg3= garbeg2.replace(" , ", ' ')
            #print garbeg3
            ...
            print "pinging Gooogle's dns (8.8.8.8)"
